...
@section('description', 'Answers to common questions about ordering, payment, shipping, returns, and B2B accounts at Shahid Brothers.')
            ...
            <div class="space-y-3">
                ...
                <div class="rounded-xl border border-gray-200 bg-white overflow-hidden"
                    ...
                    <button
                        ...
                        class="flex w-full items-center justify-between px-5 py-4 text-left text-sm font-medium text-gray-800 hover:bg-gray-50 transition"
                    ...
                    <div x-show="open === id"
                         ...
                         x-cloak
                         class="border-t border-gray-100 px-5 py-4 text-sm text-gray-600 leading-relaxed">
                        {{ $faq['a'] }}
                    </div>
                </div>
                @endforeach
        ...
        <div class="rounded-2xl bg-[#1e3a5f] p-8 text-center text-white">
            ...
            <div class="mt-5 flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center gap-x-2 rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-[#1e3a5f] hover:bg-blue-50 transition">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="https://wa.me/923084570786" target="_blank" rel="noopener noreferrer"
                   class="inline-flex items-center gap-x-2 rounded-lg bg-green-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-green-600 transition">
