...
<body class="font-sans antialiased bg-white text-gray-900">
    ...
    <a href="https://wa.me/923084570786"
       ...
       class="fixed bottom-6 end-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg shadow-green-500/40 transition-all hover:bg-green-600 hover:scale-110 active:scale-95"
